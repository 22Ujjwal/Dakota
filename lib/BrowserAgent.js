...
class BrowserAgent {
    constructor(options = {}) {
        ...
        // Model configuration with latest models
        this.modelConfig = {
    ...
    /**
     * Use OpenAI GPT-5-mini to analyze current page and provide actionable insights
     */
    async analyzePageWithGemini(instruction, options = {}) {
        ...
        try {
            ...
            // Get AI analysis using latest GPT models
            const screenshot = (options.includeScreenshot && analysisData.screenshot) ? analysisData.screenshot : null;
            const analysis = await this.createOpenAIRequest(prompt, screenshot, { maxTokens: 1500 });
     ...
     */
    /**
     * Create OpenAI request with latest models and fallbacks
     */
